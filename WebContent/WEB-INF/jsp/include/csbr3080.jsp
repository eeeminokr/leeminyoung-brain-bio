...
<script>
	...
	$(function(){
		...
		location.href = 'sample/apoe_data_excel_sample.xls';
		});
		...
		$("#btn_excel").click(function(){
			if($("#search_list_1").is(":visible")){
				var sdate = $("#sdate").val();
				var edate = $("#edate").val();
				location.href=(getContextPath() + '/include/csbr3080_print.do?sdate=' + sdate + '&edate=' + edate + '&xls=1');
			} else {
				var sdate = $("#sdate").val();
				var edate = $("#edate").val();
				location.href=(getContextPath() + '/include/csbr3080_2_print.do?sdate=' + sdate + '&edate=' + edate + '&xls=1');
			}
		});
		...
		$("#btn_upload").click(function(){
			console.log("#######");
			window.open(getContextPath() + '/include/csbr3080_upload.do','snsb_upload','width=600,height=200,scrollbars=no');
		});
	...
	function load_search_1(p) {
		...
		$.post(getContextPath()+ "/include/data/csbr3080_search.do", {sdate:sdate, edate:edate, page:p}).done(function(data){	
