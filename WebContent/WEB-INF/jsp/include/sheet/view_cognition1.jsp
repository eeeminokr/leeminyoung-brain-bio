...
//   	 $(this).prop('checked', false);
	...
	$('#insert').click(function() {
		...
		//ajax호출
		$.ajax({
			url         :   getContextPath()+"/include/sheet/view_savecognition1.do",
            dataType    :   "json",
...
<div id="btnArea"  class="btn_wrap top">
	...
	<input type ="hidden" name="exnum" id ="exnum" class ="exnum" value="${exam_num}" style="display:none;"/>
		<input type ="hidden" name="cdbs" id ="cdbs" class ="cdbs" value="0202" style="display:none;"/>
...
<div id="tabbox" style="height:auto;">
	...
	<table class="table type02">
        ...
        <thead>
            <tr>
                <th class="bg1 tbl_tit" colspan="5">언어</th>
            </tr>
            <tr>
        ...
        <tbody>
            <tr>
                <th>1</th>
                <td class="ta_l">대상자는 대화를 할 때 적절한 어휘를 찾는 데 어려움이 있는가?</td>
                <td><label><input type='radio' class='r' name='r1' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcL01())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r1' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcL01())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r1' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcL01())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>2</th>
                <td class="ta_l">주위사람들은 간혹 대상자가 말하는 내용을 이해하는 데 어려움을 겪는가?</td>
                <td><label><input type='radio' class='r' name='r2' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcL02())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r2' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcL02())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r2' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcL02())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
		</tbody>
    </table>
