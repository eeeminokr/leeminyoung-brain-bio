...
<%
	List<MbC2VO> c2_list3 = (List<MbC2VO>) request.getAttribute("c2_list3");
	MbC2VO c2vo = null;

	if( c2_list3 != null && c2_list3.size() > 0 ){
		c2vo = c2_list3.get(0);
	}
%>
<script>
...
//   	 $(this).prop('checked', false);
	...
	$('#insert').click(function() {
		...
		//ajax호출
		$.ajax({
			url         :   getContextPath()+"/include/sheet/view_savecognition1_3.do",
            dataType    :   "json",
...
<div id="btnArea" class="btn_wrap top">
	...
	<input type ="hidden" name="exnum" id ="exnum" class ="exnum" value="${exam_num}" style="display:none;"/>
		<input type ="hidden" name="cdbs" id ="cdbs" class ="cdbs" value="0204" style="display:none;"/>
...
<div id ="tabbox" style="height:auto;">
    ...
    <table class="table type02">
        ...
        <thead>
            <tr>
                <th class="bg1 tbl_tit" colspan="5">시간이나 장소에 대한 지남력</th>
            </tr>
            <tr>
        ...
        <tbody>
            <tr>
                <th>1</th>
                <td class="ta_l">대상자는 날짜나 달을 기억하는 데 어려움이 있는가?</td>
                <td><label><input type='radio' class='r' name='r1' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC01())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r1' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC01())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r1' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC01())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>2</th>
                <td class="ta_l">대상자는 다가오는 공휴일, 교회 가는 날, 세금 납부일 등을 잊어버리는가?</td>
                <td><label><input type='radio' class='r' name='r2' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC02())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r2' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC02())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r2' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC02())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>3</th>
                <td class="ta_l">대상자는 자신의 집 혹은 익순한 다른 집(친척이나 친지의 집)에서 침실이나 화장실을 찾는 데 어려움이 있는가?</td>
                <td><label><input type='radio' class='r' name='r3' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC03())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r3' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC03())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r3' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC03())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>4</th>
                <td class="ta_l">대상자는 동네가 지역 상가와 같이 익숙한 장소에서 길을 잃어버리는가?</td>
                <td><label><input type='radio' class='r' name='r4' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC04())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r4' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC04())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r4' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcC04())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
		</tbody>
    </table>
