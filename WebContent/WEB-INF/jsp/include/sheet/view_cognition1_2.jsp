...
//   	 $(this).prop('checked', false);
	...
	$('#insert').click(function() {
		...
		//ajax호출
		$.ajax({
			url         :   getContextPath()+"/include/sheet/view_savecognition1_2.do",
            dataType    :   "json",
...
<div id="btnArea" class="btn_wrap top">
	...
	<input type ="hidden" name="exnum" id ="exnum" class ="exnum" value="${exam_num}" style="display:none;"/>
		<input type ="hidden" name="cdbs" id ="cdbs" class ="cdbs" value="0203" style="display:none;"/>
...
<div id="tabbox" style="height:auto;">
	...
	<table class="table type02">
        ...
        <thead>
            <tr>
                <th class="bg1 tbl_tit" colspan="5">인격 혹은 행동</th>
            </tr>
            <tr>
                <th class="survey_date" colspan="5">
                    ...
                    <div class="sv_date">
						...
						<%if(c2vo == null) {%>value=""<%}
						else if(StringUtil.NVL(c2vo.getTestDay()) == "" ){%>value=""<%}
						else{%>value="<%=StringUtil.NVL(DateUtil.getSimpleDate("yyyyMMdd",c2vo.getTestDay()))%>"<%}%>>
					</div>
                </th>
            </tr>
            <tr>
        ...
        <tbody>
            <tr>
                <th>1</th>
                <td class="ta_l">대상자는 예기치 않게(유발시키지 않은) 화를 내거나 공격성을 보이는가?</td>
                <td><label><input type='radio' class='r' name='r1' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP01())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r1' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP01())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r1' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP01())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>2</th>
                <td class="ta_l">대상자는 실제로 존재하지 않는 물건을 보거나 소리를 들은 적이 있는가?</td>
                <td><label><input type='radio' class='r' name='r2' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP02())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r2' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP02())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r2' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP02())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>3</th>
                <td class="ta_l">대상자는 이전보다 민감해지거나 화를 내는가?</td>
                <td><label><input type='radio' class='r' name='r3' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP03())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r3' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP03())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r3' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP03())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>4</th>
                <td class="ta_l">대상자는 의심이 많아지거나 편집적이 되어 가는가?</td>
                <td><label><input type='radio' class='r' name='r4' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP04())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r4' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP04())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r4' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP04())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
            <tr>
                <th>5</th>
                <td class="ta_l">대상자는 사회적 활동이나 대화를 피하는 경향이 있는가?</td>
                <td><label><input type='radio' class='r' name='r5' value='1' <% if("1".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP05())))){%>checked <%}%>><span><em class="blind">아니오</em></span></label></td>
                <td><label><input type='radio' class='r' name='r5' value='2' <% if("2".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP05())))){%>checked <%}%>><span><em class="blind">예</em></span></label></td>
                <td><label><input type='radio' class='r' name='r5' value='3' <% if("3".equals((c2vo == null ? "" : StringUtil.NVL(c2vo.getcP05())))){%>checked <%}%>><span><em class="blind">불확실</em></span></label></td>
            </tr>
		</tbody>
    </table>
